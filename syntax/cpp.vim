...
if version >= 508 || !exists("did_cpp_syntax_inits")
  ...
  HiLink cppBoost               Type 
  HiLink cppBrackets            Type
  HiLink cppNamespace           cppNamespace
  HiLink cppType		Type
